        ...
        <div class="col-md-3">
          <div class="shop-grid-item">
            <div class="shop-item-thumb"><a href="#"><img src="assets/images/shop/showme.PNG" alt=""></a>
              <div class="shop-item-hidden"><a class="btn btn-new-white" href="shopshop_show.jsp" onclick="addPoint(777)">Add to cart</a></div>
            </div>
            <div class="shop-item-captions">
        ...
        <div class="col-md-12">
          <div class="counter">
            ...
            <div class="counter-number">
              <h6><strong id="point" class="counter-timer" data-from="0" data-to="3128">0</strong></h6>
            </div>
