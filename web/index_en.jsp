        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-white"> Everything about finance easily and conveniently in DOSS</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <p class="lead"> View all your financial history at a glance and manage them in one place.</p>
                    <ul class="arrow-list">
                        <li>Check balance by account</li>
                        <li>remittance</li>
                        <li>This Month's Consumption Analysis Report</li>
                        <li>make a habit</li>
                        <li>Points paid when visiting the store</li>
                    </ul>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="counter">
                        ...
                        <div class="counter-title">investment amount</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="counter">
                        ...
                        <div class="counter-title">people who love developers</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="counter">
                        ...
                        <div class="counter-title">bank account balance</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-9 m-auto text-center">
                    <h1>If there's money at stake, you can do it</h1>
                    <p class="lead">We make you a habit</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="number-box">
                        <h6 class="number-box-header"><span class="number-box-number">01</span><span class="number-box-title">Consumption analysis report</span></h6>
                ...
                <div class="col-md-4">
                    <div class="number-box">
                        <h6 class="number-box-header"><span class="number-box-number">02</span><span class="number-box-title">Make a habit</span></h6>
                        <div class="number-box-content">
                            <p>See how your users experience your website in realtime or view trends to see any changes in performance over time.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="number-box">
                        <h6 class="number-box-header"><span class="number-box-number">03</span><span class="number-box-title">Points paid when visiting the store</span></h6>
                        <div class="number-box-content">
                            <p>See how your users experience your website in realtime or view trends to see any changes in performance over time.</p>
                        </div>
                    </div>
    ...
    <section class="module">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-9 m-auto text-center">
                    <h1>
                        Developer: Dohee Kim<br>Enterprise: Kim Do-hee </h1>
            ...
            <div class="col-md-12">
                <p class="text-center"><a class="btn btn-circle btn-outline-brand" href="#">back to top</a></p>
            </div>
        </div>
</div>
</section>
