        ...
        <div class="inner-navigation collapse">
            <div class="inner-nav">
                <ul>
                    ...
                    <li class="menu-item-has-children menu-item-has-mega-menu"><a href="#"><span class="menu-item-span">계좌</span></a>
                        <div class="mega-menu">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <p class="lead">내 모든 금융 내역을 한 눈에 조회하고 한 곳에서 관리하세요.</p>
                    <ul class="arrow-list">
                        <li>계좌별 잔액 확인</li>
                        <li>송금</li>
